    ...
    public partial class initialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookPayment", x => new { x.BooksId, x.PaymentsId });
                    table.ForeignKey(
                        name: "FK_BookPayment_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookPayment_Payments_PaymentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookPayment_PaymentsId",
                table: "BookPayment",
                column: "PaymentsId");
